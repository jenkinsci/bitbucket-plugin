...
public class BitbucketPayloadProcessor {
    ...
    /*
     * { "canon_url": "https://bitbucket.org", "commits": [ { "author":
     * "marcus", "branch": "master", "files": [ { "file": "somefile.py", "type":
     * "modified" } ], "message": "Added some more things to somefile.py\n",
     * "node": "620ade18607a", "parents": [ "702c70160afc" ], "raw_author":
     ...
     * "/marcus/project-x/", "fork": false, "is_private": true, "name":
     * "Project X", "owner": "marcus", "scm": "git", "slug": "project-x",
     * "website": "https://atlassian.com/" }, "user": "marcus" }
     */
        ...
        if (payload.has("commits")) {
            ...
            if (commits.size() >= 1) {
                ...
                if (firstCommit.has("message")) {
                    ...
                    return message.indexOf("[ci skip]") != -1 || message.indexOf("[skip ci]") != -1
